...
class HTTPServer:
    ...
    def __search(self):
        ...
        try:
            ...
            default_field = request.args.get("default_field", default=self.__schema.get_unique_field(), type=str)
            page_num = request.args.get("page_num", default=1, type=int)
            page_len = request.args.get("page_len", default=10, type=int)

            results_page = self.__data_node.search(query, default_field=default_field, page_num=page_num,
                                                   page_len=page_len)
